...
public class Array<E> {
    ...
    /**
     * @param index 在index索引的位置插入一个新元素e
     * @param e
     */
    ...
    /**
     * @param e  查找数组中元素e所在的索引，如果不存在元素e，则返回-1
     * @return
     */
    public int find(E e){
        for(int i = 0 ; i < size ; i ++){
    ...
    /**
     * @param index 从数组中删除index位置的元素, 返回删除的元素
     * @return
     */
